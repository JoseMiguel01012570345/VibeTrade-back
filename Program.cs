...
builder.Services.AddScoped<IPartySoftLeaveCoordinator, PartySoftLeaveCoordinator>();
...
builder.Services.AddScoped<ICarrierTelemetryService, CarrierTelemetryService>();
builder.Services.AddScoped<ICarrierOwnershipService, CarrierOwnershipService>();
builder.Services.AddScoped<ICarrierDeliveryEvidenceService, CarrierDeliveryEvidenceService>();
