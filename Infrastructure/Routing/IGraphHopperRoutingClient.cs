...
using VibeTrade.Backend.Infrastructure.Http;

namespace VibeTrade.Backend.Infrastructure.Routing;

public interface IGraphHopperRoutingClient : IDrivingLegRoutingService;
...
public sealed class GraphHopperDrivingLegService(
    ...
    ILogger<GraphHopperDrivingLegService> log) : IGraphHopperRoutingClient
{
